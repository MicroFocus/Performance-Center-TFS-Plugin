...
function validateNodeVersion() {
  ...
  if (major < 16) {
    var msg =
      "The OpenText Enterprise Performance Engineering Download Scripts task requires Node.js 16 or later." +
    ...
    console.warn(
      "WARNING: Running the OpenText Enterprise Performance Engineering Download Scripts task on Node " +
...
console.log(
  "[LRE Download Scripts Bootstrap] Node runtime: " + process.version +
  " -> ./dist/LreDownloadScriptsTask/index.js"
);

var runtimeModule = require("./dist/LreDownloadScriptsTask/index.js");
